...
execute if score $val_loot ts.mm.settings matches 1..2 run data modify entity @s ArmorItems[2] merge value {id:"minecraft:netherite_chestplate",Count:1b,tag:{Damage:0.0-0.1}}

...
execute if score $loot ts.mm.settings matches 1 run data modify entity @s HandItems[1] merge value {id:"minecraft:coal",Count:5b}
execute if score $loot ts.mm.settings matches 1 run data modify entity @s HandItems[0] merge value {id:"minecraft:stone_pickaxe",Count:1b}

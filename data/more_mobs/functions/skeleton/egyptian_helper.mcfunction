...
execute if score $loot ts.mm.settings matches 1 run data modify entity @s HandItems[1] merge value {id:"minecraft:tipped_arrow",Count:3b,tag:{Potion:"minecraft:long_poison"}}

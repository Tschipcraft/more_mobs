...
execute as @s[type=minecraft:husk,tag=ts.mm.mummy] at @s run particle minecraft:block sand ~ ~1 ~ 0.2 0.4 0.2 0.1 7
execute as @s[type=minecraft:skeleton,tag=ts.mm.pharaoh] at @s run particle minecraft:block sand ~ ~1 ~ 0.2 0.4 0.2 0.1 7

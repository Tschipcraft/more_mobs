...
execute unless score global mm_version matches 0 if score Global spa_a_test matches 0 as @e[type=minecraft:piglin,tag=!parsed,tag=!exclude] at @s run function more_mobs:general/parse

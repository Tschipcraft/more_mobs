...
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=5..15}] if block ~ ~-1 ~ minecraft:sandstone run function more_mobs:skeleton/pharaoh_servant
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=16..19}] if block ~ ~-1 ~ minecraft:sandstone run function more_mobs:skeleton/golden_pharaoh
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=9..11}] run function more_mobs:skeleton/zombie
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=12..13}] run function more_mobs:skeleton/magic
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=5..9}] if block ~ ~-1 ~ minecraft:grass_block[snowy=true] run function more_mobs:skeleton/snowy
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=1..2}] if block ~ ~ ~ minecraft:water run function more_mobs:skeleton/sunken/sunken_1
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=3..4}] if block ~ ~ ~ minecraft:water run function more_mobs:skeleton/sunken/sunken_2
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=5..6}] if block ~ ~ ~ minecraft:water run function more_mobs:skeleton/sunken/sunken_3
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=7}] if block ~ ~ ~ minecraft:water run function more_mobs:skeleton/sunken/sunken_4
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=9..14}] if block ~ ~ ~ minecraft:water run function more_mobs:skeleton/pirate
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=15..16}] if block ~ ~ ~ minecraft:water run function more_mobs:skeleton/captain
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=17..19}] if block ~ ~ ~ minecraft:water run function more_mobs:skeleton/drowned
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=14..16}] if block ~ ~-1 ~ #more_mobs:jungle_blocks run function more_mobs:skeleton/mossy
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=16..}] if block ~ ~-1 ~ minecraft:grass_block run function more_mobs:skeleton/overgrown
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=1..6}] if block ~ ~-1 ~ #minecraft:sand run function more_mobs:skeleton/egyptian_helper
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=9..11}] if block ~ ~ ~ minecraft:cave_air run function more_mobs:skeleton/miner
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=12..16}] if block ~ ~ ~ minecraft:cave_air run function more_mobs:skeleton/radioactive
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=16..}] if block ~ ~-1 ~ #minecraft:base_stone_overworld run function more_mobs:skeleton/rotting
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=19}] run function more_mobs:skeleton/creeper
execute as @s[type=minecraft:skeleton,tag=!ts.mm.parsed,scores={ts.mm.random=20}] run function more_mobs:skeleton/necromancer
...
execute as @s[type=minecraft:evoker,tag=!ts.mm.parsed,scores={ts.mm.random=15..16}] run function more_mobs:evoker/illusionist

# Pillager
execute as @s[type=minecraft:pillager,tag=!ts.mm.parsed,scores={ts.mm.random=10..12}] run function more_mobs:pillager/injured
execute as @s[type=minecraft:pillager,tag=!ts.mm.parsed,scores={ts.mm.random=13..16}] run function more_mobs:pillager/bad_omen

# Vindicator
execute as @s[type=minecraft:vindicator,tag=!ts.mm.parsed,scores={ts.mm.random=10..12}] run function more_mobs:vindicator/injured

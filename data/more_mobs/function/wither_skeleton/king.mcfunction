...
execute if score $val_loot ts.mm.settings matches 1..2 run data modify entity @s equipment.chest set value {id:"minecraft:netherite_chestplate",components:{"minecraft:damage":590}}
